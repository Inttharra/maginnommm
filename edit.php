<?php
    ...
    if (isset($_GET['edit'])) {
        $id = $_GET['edit'];
        $menu_edit = "SELECT * FROM menu WHERE id = '$id'";
        $menu_edit_result = mysqli_query($conn, $menu_edit);
    } else {
        ...
        <div class="row my-5">
            ...
            <div class="col-10 col-sm-10 col-md-6">
                ...
                <div class="row mb-3 fs-3">
                    <div class="text-center"> แก้ไขเมนูอาหาร </div>
                </div>
                <div class="row mb-3">
                    <form action="php/edit_menu_db.php" method="post">
                        <input type="hidden" name="accountID" value="<?php echo $_SESSION['id'] ?>">
                        <?php if(mysqli_num_rows($menu_edit_result)) { $menu = mysqli_fetch_array($menu_edit_result) ?>
                            <input type="hidden" name="menu_id" value="<?php echo $menu['id'] ?>">
                            <div class="row mb-3">
                            <div class="col-12 col-sm-12 col-md-4">
                                <label for="name" class="form-label">ชื่อเมนูอาหาร</label>
                                <input type="text" name="name" required placeholder="ใส่ชื่อเมนูอาหาร" class="form-control" value="<?php echo $menu['foodname'] ?>">
                            </div>
                            <div class="col-12 col-sm-12 col-md-4">
                                <label for="price" class="form-label">ราคาอาหาร</label>
                                <input type="text" name="price" required placeholder="ใส่ราคาอาหาร" class="form-control" value="<?php echo $menu['price'] ?>">
                            </div>
                            <div class="col-12 col-sm-12 col-md-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" style="height: 100px" required name="details">
